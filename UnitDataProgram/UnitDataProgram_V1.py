...
while(1):
    ...
    animalPrompt = input('Enter animal: (To view list of animals enter "view list"), (to look for specific unit enter "search") ')

    if animalPrompt.lower() == "view list":
        print(*animalList, sep='\n')
        animalPrompt = input('Enter animal: (To view list of animals enter "view list") ')
